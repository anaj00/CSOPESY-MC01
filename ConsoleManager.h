...
private:
    void initialize(); // Function to initialize the console manager
    void processCommands(); // Function to process commands
    void handleCommand(const std::string& command); // Function to handle a specific command
